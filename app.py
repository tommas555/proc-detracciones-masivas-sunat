...
app.config['SECRET_KEY'] = 'clave_secreta_para_flask_2025'  # Cambia esto en producción
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function() {
        setTimeout(function() {
            filesInput.value = '';  // Vaciar input
            submitButton.disabled = true;  // Desactivar botón
            fileCountDiv.textContent = "Ningún archivo seleccionado.";  // Resetear mensaje
        }, 1500); // 1.5 segundos para asegurar que la descarga inicie
    });
});
</script>
'''
        ...
        with TemporaryDirectory() as input_temp, TemporaryDirectory() as output_temp:
            ...
            try:
                ...
                run_pipeline(
                    ...
                    lote="250001",
                    min_monto=Decimal("700.00"),  # Ajustado a normativa SUNAT
